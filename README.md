...
[![GitHub Issues](https://img.shields.io/github/issues/trepichio/smartranking-api-gateway)](https://github.com/trepichio/smartranking-api-gateway/issues)
[![GitHub Pull Requests](https://img.shields.io/github/issues-pr/trepichio/smartranking-api-gateway)](https://github.com/trepichio/smartranking-api-gateway/pulls)

![GitHUb Repo Views](https://visitor-badge.glitch.me/badge?page_id=smartranking-api-gateway.visitor-badge) ![GitHub Repo stars](https://badgen.net/github/stars/trepichio/smartranking-api-gateway)
![GitHub top language](https://img.shields.io/github/languages/top/trepichio/smartranking-api-gateway?style=falt)
[![License](https://img.shields.io/badge/license-MIT-blue.svg)](/LICENSE)
</div>

---

<p align="center"> It is a application that registers players and allows them to challenge each other, saves their match results and provides a leaderboard. <b>This repository is the API Gateway of the application built on the Microservices architecture.</b> </p>
    <br>
</p>
...
**This repository is ONLY the *API Gateway* of the application built on the Microservices architecture.**
...
![Microservices Architecture Approach Diagram](./src/static/assets/images/SmartRanking.API_Gateway.svg)
...
```
$ git clone https://github.com/trepichio/smartranking-api-gateway.git
```
...
Now, you have the **API Gateway** up and running! Check whether the other pieces of applications are running as well like the Messaging Broker and [the microservices](#the_microservices_architecture). Then, You can use any REST Client you like and consume any of API endpoints such as
